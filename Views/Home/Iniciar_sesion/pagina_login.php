...
<body><div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <a href="pagina_registrar.php"><h2 class="active" > Registrarse </a></h2>

    <!-- Login Form -->
    <form action="../../../Controllers/Login/logear.php" method="POST" autocomplete="off">
      ...
      <a href="../inicio/pagina_principal.php">Regresar</a>
    </form>
