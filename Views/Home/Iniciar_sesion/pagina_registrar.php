...
<body>
		<form action="../../../Controllers/Login/registrarController.php" method="POST">
      <br><br>
        ...
        <label for="genero">Escriba el Id de su rol..</label>
				<input placeholder="Escriba una contraseña..." name="rol" type="text" id="tabla" required>
